...
class _DemoState extends State<Demo> {
  ...
  Widget build(BuildContext context) {
    return WidgetDemo(
      ...
      codeUrl: 'https://github.com/alibaba-paimai-frontend/flutter-common-widgets-app/blob/dev/yifeng-0.0.4/lib/widgets/elements/Form/Button/TextField/index.dart',
      child: allTextFields(context,this),
 ...
 * 所有的 TextField 按钮
 */
Widget allTextFields(BuildContext context,_DemoState that){
      ...
      child: Column(
        //mainAxisSize: MainAxisSize.max,
          children: <Widget>[
            ...
            textAlignBar(_textFieldText1),
            ButtonBar(
              alignment: MainAxisAlignment.spaceAround,
              mainAxisSize: MainAxisSize.max,
              children: <Widget>[
                TextFieldDefault(context),
                SizedBox(width: 20.0), // 间距
                TextFieldDefault(context, false),
              ],
            ),
            textAlignBar(_textFieldText2),
            ButtonBar(
              alignment: MainAxisAlignment.spaceAround,
              //mainAxisSize: MainAxisSize.min,
              children: <Widget>[
                TextFieldIconDefault(context),
                TextFieldIconDefault(context, false),
              ],
            ),
            ButtonBar(
              alignment: MainAxisAlignment.spaceAround,
              //mainAxisSize: MainAxisSize.min,
              children: <Widget>[
                TextFieldIconDefault(context, true, Icons.android),
                TextFieldIconDefault(context, true, Icons.announcement),
              ],
            ),
            textAlignBar(_textFieldText3),
            SizedBox(height: 10.0),
            TextFieldCustom(context,'主要按钮',Colors.blue,buttonShape),
            SizedBox(height: 10.0),
            TextFieldCustom(context,'成功按钮',Colors.green,buttonShape),
            SizedBox(height: 10.0),
            TextFieldCustom(context,'信息按钮',Colors.grey,buttonShape),
            SizedBox(height: 10.0),
            TextFieldCustom(context,'警告按钮',Colors.orange,buttonShape),
            SizedBox(height: 10.0),
            TextFieldCustom(context,'危险按钮',Colors.pink,buttonShape),
            SizedBox(height: 10.0),
            TextFieldCustom(context, '点击切换，按钮的圆角', Colors.blue, buttonShape,
...
* isDisabled:是否是禁用
* */
Widget TextFieldDefault(BuildContext context, [bool isDisabled = true]) {
  return TextField(
    // 文本内容
...
* TextField 自定义的实例
* */
Widget TextFieldCustom(BuildContext context,
    [
      String txt = '自定义按钮',
  ...
  return TextField(
    // 文本内容
      ...
      // 按钮主题,主要用于与ButtonTheme和ButtonThemeData一起使用来定义按钮的基色,TextField，TextField，OutlineButton，它们是基于环境ButtonTheme配置的
